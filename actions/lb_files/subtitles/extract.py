...
def extract_subtitles():
    ...
    tb_update('tb_info', f"🎯 Extracting subtitles from {len(mkv_files)} file(s)", "normal")
    tb_update('tb_info', f"🔧 Using mkvextract: {mkvextract_path}", "normal")
    ...
    tb_update('tb_info', "", "normal")
    tb_update('tb_info', "✅ Subtitle extraction completed", "normal")
